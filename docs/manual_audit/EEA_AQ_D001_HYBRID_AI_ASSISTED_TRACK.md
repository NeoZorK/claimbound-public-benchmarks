# EEA AQ D-001 Hybrid AI-Assisted Track Runbook

This document is a complete hybrid human-plus-AI runbook for the EEA Air
Quality D-001 track.
...
For the shorter autonomous AI-agent prompt, use
[docs/manual_audit/EEA_AQ_D001_AI_ASSISTED_TRACK.md](EEA_AQ_D001_AI_ASSISTED_TRACK.md).
...
197. Create the evidence card.
     ...
     cat > "$CARD_PATH" <<EOF
     {
       ...
       "result_status": "$STATUS",
       "runner_command": "Hybrid AI-assisted manual runbook docs/manual_audit/EEA_AQ_D001_HYBRID_AI_ASSISTED_TRACK.md plus local external inspection script",
